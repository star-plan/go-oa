...
<div class="left-side sticky-left-side">
    ...
    <div class="logo">
        <a href="/"><img src="/static/img/logo-left.png" alt="OPMS管理系统"></a>
    </div>
    <div class="logo-icon text-center">
        <a href="/"><img src="/static/img/logo_icon.png" style="width:40px;" alt="OPMS管理系统"></a>
    </div>
    ...
    <div class="left-side-inner">
        ...
        <div class="visible-xs hidden-sm hidden-md hidden-lg">
            <div class="media logged-user">
                <img alt="{{.LoginUsername}}" src="{{getAvatar .LoginAvatar}}" class="media-object">
