...
<section> {{template "inc/left.tpl" .}}
    ...
    <div class="main-content">
        ...
        <div class="header-section"><a class="toggle-btn"><i class="fa fa-bars"></i></a> {{template "inc/user-info.tpl"
            .}}
        </div>
        <!-- header section end-->
        <!-- page heading start-->
            ...
            <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="profile-pic text-center"><img alt="{{getRealname .user.Id}}"
                                                                              src="{{getAvatarUserid .user.Id}}"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            ...
                            <div class="panel">
                                <div class="panel-body p-states">
                                    ...
                                    <ul class="dropdown-list normal-list">
                                        {{range $k,$v := .notices}}
                                        <li class="new"><a href="#noticeModal" data-toggle="modal"
                                                           data-content="{{$v.Content}}"> <span
                                                class="label label-danger"><i class="fa fa-bolt"></i></span> <span
                                                class="name">{{$v.Title}} </span> <em class="small">{{getDateMH
                                            $v.Created}}</em> </a></li>
                                        {{end}}
                ...
                <div class="col-md-8">
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="profile-desk">
                                        <h1>
                                            待审批
                                            <a class="pull-right" style="font-size:16px;" href="/my/project">更多</a>
                                        </h1>
                    ...
                    <div class="row sr-only">
                        <div class="col-md-12">
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="profile-desk">
                                        <h1>项目<a class="pull-right" style="font-size:16px;"
                                                   href="/my/project">更多</a></h1>
                                        <table class="table table-bordered table-striped table-condensed cf">
                                            <thead class="cf">
                                            <tr>
                                                <th>项目名称</th>
                    ...
                    <div class="row sr-only">
                        <div class="col-md-12">
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="profile-desk">
                                        <h1>任务<a class="pull-right" style="font-size:16px;" href="/my/task">更多</a>
                                        </h1>
                                        <table class="table table-bordered table-striped table-condensed cf">
                                            <thead class="cf">
                                            <tr>
                    ...
                    <div class="row sr-only">
                        <div class="col-md-12">
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="profile-desk">
                                        <h1>Bug<a class="pull-right" style="font-size:16px;" href="/my/test">更多</a>
                                        </h1>
                                        <table class="table table-bordered table-striped table-condensed cf">
                                            <thead class="cf">
                                            <tr>
                                            ...
                                            <tr> {{range $k,$v := .tests}}
                                                ...
                                                <td><a href="/user/show/{{$v.Userid}}">{{getRealname $v.Userid}}</a>
                                                </td>
                                            </tr>
                                            {{end}}
                                            </tbody>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel">
                                <header class="panel-heading"> 知识 <span class="pull-right"> <a
                                        href="/knowledge/manage?filter=me">更多</a></span></header>
                                <div class="panel-body">
                                    <ul class="activity-list">
                                        {{range $k,$v := .knowledges}}
                                        <li>
                                            <div class="avatar"><img src="{{getAvatarUserid $v.Userid}}"
                                                                     alt="{{getRealname $v.Userid}}"></div>
                                            <div class="activity-desk">
                                                <h5><a href="/user/show/{{$v.Userid}}">{{getRealname $v.Userid}}</a>
                                                    <span><a href="/knowledge/{{$v.Id}}" style="color:#2a323f">{{$v.Title}}</a></span>
                                                </h5>
                                                <p class="text-muted">{{$v.Summary}}</p>
                                                <p class="pull-right text-muted"><i class="fa fa-eye"></i>
                                                    {{$v.Viewnum}}&nbsp;&nbsp;&nbsp;<i class="fa fa-heart"></i>
                                                    {{$v.Laudnum}}&nbsp;&nbsp;&nbsp;<i class="fa fa-envelope-o"></i>
                                                    {{$v.Comtnum}}&nbsp;&nbsp;&nbsp;{{getDateMH $v.Created}}</p>
                                            </div>
                                        </li>
                                        {{end}}
                                    </ul>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel">
                                <header class="panel-heading"> 相册 <span class="pull-right"> <a
                                        href="/album/manage?filter=me">更多</a></span></header>
                                <div class="panel-body">
                                    <div id="gallery" class="media-gal"> {{range $k,$v := .albums}}
